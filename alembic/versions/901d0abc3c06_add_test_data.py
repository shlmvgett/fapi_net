...
def upgrade() -> None:
    op.execute(f"""INSERT INTO users (name, last_name, email, password, bday, sex, interests, city)
            VALUES ('name1', 'last_name1', 'user1@test.com', '123', '1999-11-11', 'male', array['i1', 'i2'], 'London'),
                    ('name2', 'last_name2', 'user2@test.com', '123', '1999-11-11', 'male', array['i3'], 'Madrid'),
                    ('name3', 'last_name3', 'user3@test.com', '123', '1999-11-11', 'male', array['i2', 'i3'], 'Paris')""")
